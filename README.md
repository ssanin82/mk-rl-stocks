...
All configuration parameters are defined in `settings.json`. 

📖 **For detailed documentation of all settings, parameters, and tuning guidelines, see [settings.md](settings.md).**

The configuration file includes:
- Common settings (data, training, model parameters)
- Reward shaping settings (10 parameters for optimizing P&L)
- BTC-specific settings (capital, fees, position management)
